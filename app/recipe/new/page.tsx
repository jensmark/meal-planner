                    ...
                    <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl">
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3 sm:col-start-1">
                                ...
                                <div className="mt-2">
                                    <input id="name" name="name" type="text" minLength={3} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                </div>
                            </div>
