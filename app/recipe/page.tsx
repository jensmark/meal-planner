              ...
              <div key={recipe.id} className="group relative">
                ...
                {session.user.id === recipe.createdBy ? 
                  <div className="mt-4 flex justify-between">
                    ...
                    <button type="button" className="flex justify-center rounded-md h-10 bg-red-600 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-indigo-400">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
